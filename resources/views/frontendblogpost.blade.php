...
<div class="w3l-bootstrap-header fixed-top">
  <nav class="navbar navbar-expand-lg navbar-light p-2">
    <div class="container">
      <a class="navbar-brand" href="index.html"><span class=""></span><TABLE><img src="../assets/images/logoalgotech.png" width="140px" alt="jasa pembuatan android"></TABLE></a>
        ...
        <div class="row footer-top-30">
          <div class="col-lg-2 col-md-7 col-sm-5 footer-list-29 footer-1">
            <div class="footer-logo mb-1" style="margin-top: -100px">
              ...
              <span></span><img src="https://jasa-website.id/assets/images/logoalgotech.png" alt="Jasa Pembuatan Website Profesional" title="Jasa Pembuatan Website Profesional" style="height:90px;" /><span class="logo"></span></a>
            </div>
         <ul>
